...
When doing this project, we find that striking the balance among the weights, a<sub>l</sub> and b<sub>l</sub>, of losses is a nontrivial work. There is no solid theory that guides us to tune them, and we feel that the balance is just occasionally struck. This may be why people seek other approaches such as feed-forward methods.
